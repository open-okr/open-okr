...
| P1-T05 | Authentication: password, passkeys, one-time codes | in_progress | task/p1-t05-authentication | 2026-08-05 | Human approved: @better-auth/passkey plus its SimpleWebAuthn dependencies; lockout and forgot/reset in scope, single sign-on deferred to P8-T07; auth pages carry S-35 behaviour now and get the S-35 visual treatment in P2-T10; auth migration hand-written with not-tenant-scoped and hard-delete markers; BETTER_AUTH_SECRET has a loud development placeholder that production refuses. Session-token hashing is the risk: if Better Auth exposes no supported seam, stop and ask rather than hand-roll |
