...
| P1-T03 | Database package + tenant floor + test isolation | in_review | task/p1-t03-db-tenant-floor, PR #9 merged; rework PR #11 | 2026-08-05 | Spike decision: GO, recorded in docs/design/p1-t03-tenant-isolation-spike.md. Isolation held under PgBouncer transaction pooling; R1 fallback not invoked. No product tables shipped; the probe table is a test fixture, so the §7.2 importer mapping is unchanged |
